                    ...
                    <div className="row text-center">
                        ...
                        <div className="col-md-6">
							<div className="form-group">
								...
								<input type="text" class="form-control" id="qualificationDetails" placeholder="Your degree">
							    </input>
							</div>
                        </div>
                        <div className="col-md-6">
							<div className="form-group">
								...
								<input type="text" class="form-control" id="yearsOfExperience" placeholder="Yrs of exp.">
							    </input>
							</div>
                        </div>
                        <div className="col-md-6">
